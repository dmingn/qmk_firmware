...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
    ...
    _______, KC_EXLM, JP_AT,   KC_HASH, KC_DLR,  KC_PERC, JU_LBRC,                   JU_RBRC, JP_CIRC, JP_AMPR, JP_ASTR, JP_LPRN, JP_RPRN, _______, \
    _______, KC_1,    JU_2,    KC_3,    KC_4,    KC_5,    JP_LCBR,                   JP_RCBR, JU_6,    JU_7,    JU_8,    JU_9,    JU_0,    _______, \
   ...
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * | ____ |      |      |      |      |      |      |                    |      | Left | Down |  Up  | Right|      | ____ |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | ____ |      |      |      |      |      | ____ |                    | ____ |      |      |      |      |      | ____ |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | ____ | ____ | ____ | ____ |||||||| Lower| ____ | ____ |||||||| ____ | ____ | Raise|||||||| ____ | ____ | ____ | ____ |
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_RAISE] = LAYOUT(
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, \
    _______, KC_1,    JU_2,    KC_3,    KC_4,    KC_5,    XXXXXXX,                   XXXXXXX, JU_6,    JU_7,    JU_8,    JU_9,    JU_0,    _______, \
