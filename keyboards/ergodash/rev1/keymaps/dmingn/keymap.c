...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_QWERTY] = LAYOUT( \
    KC_ESC,  KC_1,    JU_2,    KC_3,    KC_4,    KC_5,    JU_LBRC,                   JU_RBRC, JU_6,    JU_7,    JU_8,    JU_9,    JU_0,    KC_PSCR, \
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    JU_MINS,                   JU_EQL,  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    JU_BSLS, \
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    JU_GRV,                    KC_UNDS, KC_H,    KC_J,    KC_K,    KC_L,    JU_SCLN, JU_QUOT, \
